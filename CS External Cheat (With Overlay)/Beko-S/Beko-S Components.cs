...
namespace Client
{
    ...
    class iTalk_ComboBox : ComboBox
    {
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            if (!(e.Index == -1))
            {
                e.Graphics.DrawString(GetItemText(Items[e.Index]), e.Font, new SolidBrush(Color.FromArgb(70, 70, 70)), e.Bounds);
            }
        }
        ...
        public iTalk_ComboBox()
        {
            ...
            BackColor = Color.FromArgb(246, 246, 246);
            ForeColor = Color.FromArgb(2, 4, 6);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(new Pen(Color.FromArgb(20, 20, 20), 2), new Point(Width - 18, 10), new Point(Width - 14, 14));
            e.Graphics.DrawLine(new Pen(Color.FromArgb(20, 20, 20), 2), new Point(Width - 14, 14), new Point(Width - 10, 10));
            e.Graphics.DrawLine(new Pen(Color.FromArgb(20, 20, 20)), new Point(Width - 14, 15), new Point(Width - 14, 14));
    ...
    // Tab Controls
    #region Beko_TabControl_Left

    class Beko_TabControl_Left : TabControl
    {

        static public Color Cerceve = Color.FromArgb(17, 17, 17);
        private Color dikeycizgi = Cerceve;

        public Color TabRengi = Color.FromArgb(17, 17, 17);
        public Color SeciliTabRengi = Color.FromArgb(25, 25, 25);

        public Color YaziRengi = Color.FromArgb(0, 180, 80);
        public Color SeciliYaziRengi = Color.FromArgb(0, 180, 80);

        public Color Isaret = Color.FromArgb(0, 180, 80);

        /*
        public int TextSolaUzaklık = 40;
        public int SeciliTextSolaUzaklık = 30;
        */
        public int TextSolaUzaklık = 35;
        public int SeciliTextSolaUzaklık = 25;


        public Beko_TabControl_Left()
        {
            SetStyle(ControlStyles.AllPaintingInWmPaint | ControlStyles.UserPaint | ControlStyles.ResizeRedraw | ControlStyles.DoubleBuffer, true);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            _Graphics.Clear(Cerceve); //other big bg which was originally white
            ...
            _Graphics.FillRectangle(new SolidBrush(TabRengi), new Rectangle(-5, 0, ItemSize.Height + 4, Height));//26, 38, 63 orig dark grey
            // Draw vertical line at the end of the tab selector rectangle
            _Graphics.DrawLine(new Pen(dikeycizgi), ItemSize.Height - 1, 0, ItemSize.Height - 1, Height);
            ...
            for (int TabIndex = 0; TabIndex <= TabCount - 1; TabIndex++)
            {
                if (TabIndex == SelectedIndex)
                {
                    ...
                    _Graphics.FillRectangle(new SolidBrush(SeciliTabRengi), TabRect.X, TabRect.Y, TabRect.Width - 4, TabRect.Height + 3); //orig almost black (selected tab color)
                    ...
                    _Graphics.FillRectangle(new SolidBrush(Isaret), TabHighlighter); //side of selected tab color
                    // Draw tab text
                    _Graphics.DrawString(TabPages[TabIndex].Text, new Font(Font.FontFamily, Font.Size, FontStyle.Bold), new SolidBrush(SeciliYaziRengi), new Rectangle(TabRect.Left + SeciliTextSolaUzaklık, TabRect.Top + 12, TabRect.Width - 40, TabRect.Height), new StringFormat { Alignment = StringAlignment.Near });
                ...
                {
                    Rectangle TabRect = new Rectangle(new Point(GetTabRect(TabIndex).Location.X - 2, GetTabRect(TabIndex).Location.Y - 2), new Size(GetTabRect(TabIndex).Width + 3, GetTabRect(TabIndex).Height - 8));
                    _Graphics.DrawString(TabPages[TabIndex].Text, new Font(Font.FontFamily, Font.Size, FontStyle.Bold), new SolidBrush(YaziRengi), new Rectangle(TabRect.Left + TextSolaUzaklık, TabRect.Top + 12, TabRect.Width - 40, TabRect.Height), new StringFormat { Alignment = StringAlignment.Near });
    ...
    #region Beko_TabControl_Bottom


    class Beko_TabControl_Bottom : TabControl
    {

        TabSizeMode sizeMode = TabSizeMode.Fixed; // Tab Size Modu

        int tabUzunluk = 160; // Tabın Uzunluğu
        int tabGenislik = 60; // Tabın Genişliği
        int cizgiYeri = 323; // Yatay Cizgi Yeri

        private Color headerColor = Color.FromArgb(13, 13, 13); // Tab Rengi
        public Color activeColor = Color.FromArgb(20, 20, 20); // Secili Tab Rengi

        private Color horizLineColor = Color.DodgerBlue; // Yatay Cizgi Rengi

        private Color textColor = Color.FromArgb(24, 116, 205); // Yazı Rengi
        public Color selectedTextColor = Color.FromArgb(30, 144, 255); // Secili Yazı Rengi



        private Color backTabColor = Color.FromArgb(25, 25, 25); // Arkaplan Rengi
        ...
        public Beko_TabControl_Bottom()
        {
            ...
            DoubleBuffered = true;
            SizeMode = sizeMode;
            ItemSize = new Size(tabUzunluk, tabGenislik);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Drawer.DrawLine(new Pen(this.horizLineColor, 5), new Point(0, cizgiYeri), new Point(Width, cizgiYeri));


            // Draws the background of the tab control
            Drawer.FillRectangle(new SolidBrush(this.backTabColor), new Rectangle(Height - tabGenislik, Height, Width, Height - tabGenislik));
    ...
    #region Beko_TabControl_Top

    class Beko_TabControl_Top : TabControl
    {

        TabSizeMode sizeMode = TabSizeMode.Fixed; // Tab Size Modu

        int tabUzunluk = 300; // Tabın Uzunluğu
        int tabGenislik = 60; // Tabın Genişliği
        int cizgiYeri = 51; // Yatay Cizgi Yeri

        private Color backTabColor = Color.FromArgb(25, 25, 25); // Tab Rengi
        public Color activeColor = Color.FromArgb(50, 50, 50); // Secili Tab Rengi

        private Color horizLineColor = Color.DodgerBlue; // Yatay Cizgi Rengi

        private Color textColor = Color.FromArgb(240, 240, 240); // Yazı Rengi
        public Color selectedTextColor = Color.FromArgb(255, 255, 255); // Secili Yazı Rengi

        public Color borderColor = Color.FromArgb(25, 25, 25); // Cerceve Rengi
        ...
        /// </summary>
        private Color headerColor = Color.FromArgb(25, 25, 25);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // Draws the background of the tab control
            Drawer.FillRectangle(new SolidBrush(this.backTabColor), new Rectangle(0, tabGenislik, Width, Height - tabGenislik));
    ...
    // Check Boxes
    #region Beko_CheckBox_Square

    class Beko_CheckBox_Square : CheckBox
    {

        public Color BoxRengi = Color.FromArgb(17, 17, 17);
        public Color SeciliBoxRengi = Color.FromArgb(140, 50, 170);
        public int BoxBoyutu = 16;

        public Color BorderRengi = Color.FromArgb(170, 170, 170);
        public int BoxBorderBoyutu = 1;

        bool IkinciBorder = true;
        public Color IkinciBorderRengi = Color.FromArgb(17, 17, 17);
        public int BoxIkinciBorderBoyutu = 1;



        public Beko_CheckBox_Square()
        {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            int SBoxBoyut = BoxBoyutu - BoxBorderBoyutu * 2;

            pevent.Graphics.FillRectangle(new SolidBrush(BorderRengi), new Rectangle(0, 0, BoxBoyutu, BoxBoyutu));
            pevent.Graphics.FillRectangle(new SolidBrush(IkinciBorderRengi), new Rectangle(BoxBorderBoyutu, BoxBorderBoyutu, SBoxBoyut, SBoxBoyut));

            if (!this.Checked)
            {
                pevent.Graphics.FillRectangle(new SolidBrush(BoxRengi), new Rectangle(BoxBorderBoyutu, BoxBorderBoyutu, SBoxBoyut, SBoxBoyut));
            }
            else
            {
                ...
                if (IkinciBorder)
                {
                    pevent.Graphics.FillRectangle(new SolidBrush(SeciliBoxRengi), new Rectangle(BoxBorderBoyutu + BoxIkinciBorderBoyutu, BoxBorderBoyutu + BoxIkinciBorderBoyutu, SBoxBoyut - BoxIkinciBorderBoyutu * 2, SBoxBoyut - BoxIkinciBorderBoyutu * 2));
                }
                else
                {
                    pevent.Graphics.FillRectangle(new SolidBrush(SeciliBoxRengi), new Rectangle(BoxBorderBoyutu, BoxBorderBoyutu, SBoxBoyut, SBoxBoyut));
                }
    ...
    #region Beko_TextBox_Normal

    [DefaultEvent("TextChanged")]
    class Beko_TextBox_Normal : Control
    {
        #region Variables
    ...
    // Icons
    #region Beko_Icon_Tick

    class Beko_Icon_Tick : Control
    {
        Color daireIcRengi = Color.FromArgb(19, 20, 21);
        Color sembolRengi = Color.FromArgb(0, 180, 80);

        public Beko_Icon_Tick()
        {
            this.BackColor = Color.FromArgb(19, 20, 21);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.FillEllipse(new SolidBrush(daireIcRengi), new Rectangle(3, 3, 25, 25));

            e.Graphics.DrawString("ü", new Font("Wingdings", 25, FontStyle.Bold), new SolidBrush(sembolRengi), new Rectangle(0, -3, Width, 43), new StringFormat
            {
                Alignment = StringAlignment.Near,
    ...
    #region Beko_Icon_Cross

    class Beko_Icon_Cross : Control
    {
        Color daireIcRengi = Color.FromArgb(19, 20, 21);
        Color sembolRengi = Color.FromArgb(190, 0, 25);

        public Beko_Icon_Cross()
        {
            this.BackColor = Color.FromArgb(19, 20, 21);
            this.Size = new Size(34, 34);
            DoubleBuffered = true;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString("r", new Font("Webdings", 25), new SolidBrush(sembolRengi), new Rectangle(-6, -2, Width, 43), new StringFormat
            {
                Alignment = StringAlignment.Near,
                LineAlignment = StringAlignment.Near
            });
    ...
    #region Beko_Icon_Info

    class Beko_Icon_Info : Control
    {
        Color daireIcRengi = Color.FromArgb(19, 20, 21);
        Color sembolRengi = Color.FromArgb(60, 130, 250);

        public Beko_Icon_Info()
        {
            this.BackColor = Color.FromArgb(19, 20, 21);
            this.Size = new Size(34, 34);
            DoubleBuffered = true;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString("¡", new Font("Segoe UI", 25, FontStyle.Bold), new SolidBrush(sembolRengi), new Rectangle(4, -14, Width, 43), new StringFormat
            {
                Alignment = StringAlignment.Near,
                LineAlignment = StringAlignment.Near
            });
    ...
    #region Beko_Icon_Empty

    class Beko_Icon_Empty : Control
    {
        Color daireIcRengi = Color.FromArgb(19, 20, 21);

        public Beko_Icon_Empty()
        {
            this.BackColor = Color.FromArgb(19, 20, 21);
            this.Size = new Size(34, 34);
            DoubleBuffered = true;
